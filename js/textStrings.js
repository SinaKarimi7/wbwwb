...
// Arabic translation. نحن نتحول لما نشاهده
//
// by Alex Clay https://twitter.com/_AlexanderClay
// built on the Korean Git source

var textStrings_AR = {
	// Act 1
	"niceHat": "!واو! قبعة جذابة",
	"outtaHere": "!اغرب من هنا",
	"getARoom": "!مقزز! مارسوا هذه العادة في بيتكم",
	"notCoolAnymore": ".القبعات لم تعد جذابة",
	"tvOnTv": "!التلفاز... على التلفاز",
	"cricky": "^_^ صرصور كيوت",
	"tooManyCrickets": ":( أوكي... كتير صراصير",
	"normalPeep": ".مجرد شخص عادي",
	"normalPeeps": ".مجرد جماعة عادية",
	"wowNothing": ".واو, إنه لاشيء",

	// Act 2
	"crazySquareAttacks": "!مربع مجنون يهاجم",
	"justMissed": "(قريبة كتير, بس راحت علينا)",
	"somethingInteresting": "(يجب أن تصوره و هو يقوم بشيء غريب)",
	"whoIsScreaming": "(يجب أن تصور منْ يفزِعُ ممنْ)",
	"circleFearsSquares": "!الدائرة تخاف من المربعات",
	"whoScaresThem": "(يجب أن تصور من يخيفهم)",
	"areTheyScared": "(يجب أن تصوره وهو يفزع من المربع)", // not used
	"squaresSnubCircles": "!المربعات تتكبّر على الدوائر",
	"areTheySnubbed": "(يجب أن تصوره وهو يتكبّر على دائرة)", // not used
	"everyoneHates": "!!!الجميع يكرهون بعضهم البعض",
	"almostEveryoneHates": "...الأكثرية يكرهون بعضهم البعض",
	"squaresHateCircles": "!المربعات تكره الدوائر",
	"circlesHateSquares": "!الدوائر تكره المربعات",
	"areTheyYelling": "(يجب أن تصوره وهو يصرخ على الآخرين)", // not used
	"nerdsNow": "!ماذا يفعل غرباء الأطوار هؤلاء؟",
	"schockedPeep": "لماذا هذا الشخص مصعوق؟",
	"whatever": ".لا يهمني",

	// Act 3
	"ellipsis": ". . .",
	"coolNoMore": ".ألم تسمع؟ القبعات لم تعد جذابة",
	"beScared": ".افزعْ. اغضبْ",

	// MANIFESTO
	"manifesto": [
		//"as if you viewers want GOOD news"       ,
		"!من يشاهد الأخبار ليرى الناس تتفاهم؟",
		".السّلم ممل, العنف يجلب المشاهدات",
		".السّلم ممل, العنف يجلب المشاهدات",
		".صوّر ما تريد الجماهير أن تشاهده"
	],

	// -- Strings currently in graphics resources --

	// (bg_preload.png) Preload screen
	"playingTime": ".الوقت المتوقع لختم اللّعبة: 5 دقائق",
	"warning": "تحذير: البرنامج المعروض موجّه للكبار فقط لاحتوائه\n .على مشاهد متكبرة, و مفاجئة, و عنيفة",

	// (cam-instructions.png) Camera Instructions
	"pointAndClick": "انقر بزر الفأرة",

	// (chyron3.png)
	"chyronNothing": "!واو! إنه لاشيء",

	// (credits0001.png)
	"createdBy": "لعبة من صنع",
	"NickyCase": "Nicky Case",

	// (credits0002.png)
	"manyThanks": "شكر موجّه لمختبري اللعبة",

	// (credits000[3,4,5,6].png)
	"patreonSupporters": "Patreon و لمن يدعمني على",

	// (credits0007.png)
	"lastButNotLeast": "...و أخيراً",

	// (credits0008.png)
	"thankYouForPlaying": "!!!شكراً لأنك لعبت لعبتي",

	// (preload_play.png)
	"playButton": "ابدأ",

	// (end_button.png) Post Credits
	"otherWorkButton": "شاهد أعمالي الأخرى",
	"buyCoffeeButton": "اشتري لي كوب قهوة",
	"replayButton": "ابدأ من جديد",

	// (logo.png) Post Credits
	"logoWBWWB": "!شارك اللعبة",

	// (end_prototype.png)
	"endOfPrototype": "نهاية الإختبار",
	"toBeContinued": "(يتبع)",

	// (quote0002.png)
	"WBWWB": ".نحن نصبح ما نشاهد",
	"WSOTATOTSU": ".نصنَعٌ أدواتنا, و أدواتنا تصنَعُنا",

	// (quote0003.png)
	"MarshallMcLuhan": "Marshall McLuhan",

	// (quote0004.png)
	"misatrributed": "(منسوبة للشخص الخاطئ)",
};
...
var textStrings_FA = {
    ...
    "normalPeeps"          : "چندتا آدم معمولی"                                ,
    "wowNothing"           : "هیچی نیست"                                  ,
    ...
    "nerdsNow"             : "این ندید پدیدا الان اینجا چه می‌کنند؟"                        ,
    "schockedPeep"         : "چرا این ترسیده؟"                              ,
    "whatever"             : "به هر حال"                                              ,
    ...
    // (end_button.png) Post Credits
    "otherWorkButton"    : "باقی کارها را ببین" ,
    "buyCoffeeButton"    : "یک فنجان قهوه برای نیکی" ,
    "buyTeaButton"       : "یک لیوان چای برای حامد" ,
